...
def send():
    if request.method == 'POST':
        ...
        ############# predicting #####################
        import gF
        SequencesNumber, Types, Probabilities, Sequences = gF.fastaTOprediction(step, X, Y)
        return render_template('results.html', SequencesNumber=SequencesNumber, Types=Types, Probabilities=Probabilities, nameFASTA = nameFASTA, Sequences = Sequences)
    return render_template('server.html')
